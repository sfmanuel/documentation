...
This example consists of two flow scripts. You can also find them in the public flow script library:
...
examples already. We will loop through a list of countries that are provided
...
# (2) Create a setting with country names
    ...
    First, we check if the setting already exists. If it doesn't, we create it.
